...
function UniteSection() {
  return (
    <SectionWrapper>
      ...
      <Audience>Designers · Videographers · Podcasters · Writers <br/> Content Creators · Coders · Influencers · Makers</Audience>
      <Unite>Unite</Unite>
      <p class="text-center"><Body>Let's all build <Logo src={LogoCaps} /> the good party</Body></p>
      <div class="text-center"><JoinButton>Join Now</JoinButton></div>
      ...
      <Description>
              The Good Party is a non-profit project with a simple plan to use good open-source tech to take back Democracy from big-money donors and crooked career politicians.
        We’re calling on Creators of the World to join us now to help create the free tech, messaging, visuals, audio, and stories that can organically reach and inspire millions of people.  We’re also building the tools needed to disrupt the two-party system, and get good indie / grass-roots candidates elected so that we can change politics for Good!
        <br/>
        <br/>
