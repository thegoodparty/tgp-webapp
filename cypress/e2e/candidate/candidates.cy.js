...
describe('CandidatesPage', () => {
  ...
  it('test Filter Section', () => {
    cy.get('[data-cy=filter-section-title]').contains('Filter by Top Issues');
  ...
  it('test Candidates Section', () => {
    cy.get('[data-cy=candidates-section-title]').contains(
      'Top Trending Candidates',
    );
    cy.get('[data-cy=good-certified-link]').contains('GOOD CERTIFIED?');
