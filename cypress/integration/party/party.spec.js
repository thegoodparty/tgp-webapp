...
describe('PartyPage', () => {
    ...
    it('finds events section', () => {
        ...
        cy.get('[data-cy=events-link]').contains('See All').click();
    ...
    it('finds FAQs section', () => {
        ...
        cy.get('[data-cy=faqs-link]').contains('See FAQ').click();
    ...
    it('finds ama link', () => {
        ...
        cy.get('[data-cy=ama-dialog-submit')
            ...
            .and('include', 'mailto:ask@thegoodparty.org?subject=Good%20Party%20Question&body=')
